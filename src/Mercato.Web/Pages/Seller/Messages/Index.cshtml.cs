...
/// <summary>
/// Page model for displaying the seller's customer message threads.
/// </summary>
...
public class IndexModel : PageModel
{
    ...
    /// <summary>
    /// Gets the result containing the seller's message threads.
    /// </summary>
    public GetThreadsResult? ThreadsResult { get; private set; }

    /// <summary>
    /// Handles GET requests for the seller messages index page.
    /// </summary>
    ...
    public async Task<IActionResult> OnGetAsync(int page = 1)
    {
        ...
        ThreadsResult = await _messagingService.GetSellerThreadsAsync(userId, page, DefaultPageSize);
