...
public class EditModel : PageModel
{
    ...
    /// <summary>
    /// Input model for editing a VAT rule.
    /// </summary>
    ...
    public async Task<IActionResult> OnGetAsync(Guid id)
    {
        ...
        var result = await _vatRuleService.GetRuleByIdAsync(id);
        ...
        Input = new InputModel
        {
            ...
            EffectiveFrom = rule.EffectiveFrom.UtcDateTime.Date,
            EffectiveTo = rule.EffectiveTo?.UtcDateTime.Date,
    ...
    /// <summary>
    /// Handles POST requests to update the VAT rule.
    /// </summary>
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        var result = await _vatRuleService.UpdateRuleAsync(command);
        ...
        _logger.LogInformation(
            "VAT rule '{Name}' (ID: {Id}) updated by user {UserId}",
            command.Name,
            command.Id,
            userId);

        TempData["SuccessMessage"] = $"VAT rule '{command.Name}' was updated successfully.";
        return RedirectToPage("Index");
    }
}
