...
/// <summary>
/// Query parameters for filtering seller cases (return requests).
/// </summary>
public class SellerCaseFilterQuery
{
    /// <summary>
...
/// <summary>
/// Result of a filtered seller cases query.
/// </summary>
public class GetFilteredCasesResult
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the list of return requests (cases) for the current page.
    /// </summary>
    public IReadOnlyList<ReturnRequest> Cases { get; private init; } = [];
    ...
    /// </summary>
    /// <param name="cases">The cases for the current page.</param>
    /// <param name="totalCount">The total number of cases matching the filter.</param>
    /// <param name="page">The current page number.</param>
    /// <param name="pageSize">The page size.</param>
    /// <returns>A successful result.</returns>
    public static GetFilteredCasesResult Success(IReadOnlyList<ReturnRequest> cases, int totalCount, int page, int pageSize) => new()
    {
        Succeeded = true,
        Errors = [],
        Cases = cases,
    ...
    public static GetFilteredCasesResult Failure(IReadOnlyList<string> errors) => new()
    {
        Succeeded = false,
        Errors = errors
    };
    ...
    /// <returns>A failed result.</returns>
    public static GetFilteredCasesResult Failure(string error) => Failure([error]);

    /// <summary>
    /// Creates a not authorized result.
    /// </summary>
    /// <returns>A not authorized result.</returns>
    public static GetFilteredCasesResult NotAuthorized() => new()
    {
        Succeeded = false,
        IsNotAuthorized = true,
        Errors = ["Not authorized to access these cases."]
    };
}
