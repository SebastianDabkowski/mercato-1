...
/// <summary>
/// Represents a historical record of changes made to a VAT rule.
/// This entity provides an audit trail for VAT rule modifications.
/// </summary>
public class VatRuleHistory
{
    ...
    /// <summary>
    /// Gets or sets the ID of the VAT rule that was changed.
    /// </summary>
    public Guid VatRuleId { get; set; }

    /// <summary>
    /// Gets or sets the type of change made: "Created", "Updated", or "Deleted".
    /// </summary>
