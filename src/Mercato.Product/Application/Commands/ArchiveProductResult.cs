...
/// </summary>
public class ArchiveProductResult
{
    /// <summary>
    ...
    public static ArchiveProductResult Success() => new()
    {
        Succeeded = true,
        Errors = []
    };
    ...
    public static ArchiveProductResult Failure(IReadOnlyList<string> errors) => new()
    {
        Succeeded = false,
        Errors = errors
    };
    ...
    /// <returns>A failed result.</returns>
    public static ArchiveProductResult Failure(string error) => Failure([error]);
    ...
    public static ArchiveProductResult NotAuthorized(string error) => new()
    {
        Succeeded = false,
        Errors = [error],
